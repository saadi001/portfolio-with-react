     ...
     return (
          <div className='container h-screen flex items-center justify-between mx-2'>
               <div className=''>
                    ...
                    <button className='border border-teal-400 hover:bg-teal-400 hover:text-slate-700 text-slate-300 px-4 py-2 rounded-md mt-5 text-base uppercase'>Resume</button>
               </div>
