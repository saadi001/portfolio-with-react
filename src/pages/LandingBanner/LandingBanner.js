     ...
     return (
          <div className='container h-screen flex items-center justify-between mx-2'>
               <div className=''>
                    ...
                    <button  className='border border-teal-400 hover:bg-teal-400 hover:text-slate-700 text-slate-300 px-4 py-2 rounded-md mt-5 text-base uppercase'><a href="https://drive.google.com/file/d/1nKl4X7Qz6rqEhJUdaTN1x3BKefemv437/view?usp=sharing">Resume</a></button>
               </div>
               <div className='w-[50%] border border-none rounded-[50%]'>
